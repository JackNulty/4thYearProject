...
public:  
   ...
   void reset() { boomerangThrowFlag = false; isFlying = false; isReturning = false; distanceTraveled = 0.0f; m_boomerangSprite.setPosition(10000, 10000); trailParticles->deactivate();}  
...
private:  
   ...
   std::shared_ptr<ParticleSystem> trailParticles;  
};